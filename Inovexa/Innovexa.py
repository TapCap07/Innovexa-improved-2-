        ...
        if activate=='c':
            ...
            for keyword in keys.inventions:
                ...
                if keyword in command:
                    ...
                    # if keys.inventions[keyword][0]=="Spch":
                    #     engine.say(keys.inventions[keyword][1])
                    #     engine.runAndWait()
                        
                    # if keys.inventions[keyword][0]=="consoleText":
                    #     print(keys.inventions[keyword][1])
                    
                    # if keys.inventions[keyword][0]=="Img":
                    #     image=pygame.image.load("Images/"+keys.inventions[keyword][1]+".jpeg").convert_alpha()
